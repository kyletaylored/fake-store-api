...
## Three more things fixed by actually running the deploy

Real `gcloud builds submit --config=cloudbuild.yaml` runs against a live project/`us-west1` surfaced three more Cloud Run/Cloud Build specifics, now fixed in the committed files:
